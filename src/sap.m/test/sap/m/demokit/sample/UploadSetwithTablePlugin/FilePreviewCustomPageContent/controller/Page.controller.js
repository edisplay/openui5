...
], function (Controller, UploadSetwithTable, MessageBox, Fragment, MockServer, MessageToast, Dialog, Button, mobileLibrary, Text, coreLibrary, CoreItem, Filter, FilterOperator, Element, HTML, CodeEditor, URLListValidator) {
	"use strict";

	return Controller.extend("responsiveFilePreviewCustomPageContent.table.sample.controller.Page", {
		onInit: function () {
		...
		openAddOrEditDialog: function () {
			if (!this._addViaUrlFragment){
				Fragment.load({
					name: "sap.m.sample.UploadSetwithTablePlugin.responsiveFilePreviewCustomPageContent.view.fragment.AddViaUrl",
					id: "addViaUrlDialog",
					controller: this
				})
		...
		pageContentHandler: function (oItem) {
			...
			return new Promise((resolve, reject) => {
				...
				switch (sMediaType) {
					...
					case "application/xml":
						...
						getXMLContent(oItem).then((content) => {
							resolve(
								new CodeEditor({
									type: "xml",
									editable: false,
					...
					default:
						reject(""); // rejecting the promise to display no content
						break;
				}
			});

			function getXMLContent(oItem) {
				return new Promise((resolve, reject) => {
					// demonstration to make dummy API request with item url to fetch the xml content
					resolve(`<?xml version='1.0' encoding='ISO-8859-1'?>\n<Invoice>\n    <InvoiceNumber>INV-20250327</InvoiceNumber>\n    <Date>2025-03-27</Date>\n    <Billing>\n        <BillTo>\n            <Name>Acme Corporation</Name>\n            <Address>123 Business Road, New York, NY 10001</Address>\n            <Email>billing@acmecorp.com</Email>\n        </BillTo>\n        <ShipTo>\n            <Name>Global Enterprises</Name>\n            <Address>789 Market Street, Los Angeles, CA 90001</Address>\n</ShipTo>\n    </Billing>\n    <Items>\n        <Item>\n            <Description>Wireless Keyboard</Description>\n            <Quantity>2</Quantity>\n            <UnitPrice>45.99</UnitPrice>\n            <TotalPrice>91.98</TotalPrice>\n        </Item>\n        <Item>\n            <Description>USB-C Hub</Description>\n            <Quantity>1</Quantity>\n            <UnitPrice>29.99</UnitPrice>\n            <TotalPrice>29.99</TotalPrice>\n        </Item>\n    </Items>\n    <TotalAmount>121.97</TotalAmount>\n</Invoice>\n<!-- This is a sample custom content used to demonstrate XML content loading for the preview. -->`);
				} );
			}
		}
	});
