...
sap.ui.define([
	...
	QUnit.test("Flag Marker Set", async function(assert) {
		// Arrange
	...
	QUnit.test("Flag Marker Unset", async function(assert) {
		// Arrange
		this.markerOli.setMarkFavorite(false);
	...
	QUnit.test("Favorite Marker Set", async function(assert) {
		// Arrange
	...
	QUnit.test("Favorite Marker Unset", async function(assert) {
		// Arrange
		this.markerOli.setMarkFavorite(false);
		this.markerOli.setMarkFlagged(false);
