...
sap.ui.define([
	...
	var oSubLanguages = EditorQunitUtils.getRandomPropertiesOfObject(Utils.languageMapping, 6);
				...
				return new Promise(function (resolve, reject) {
					EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
						...
						EditorQunitUtils.isReady(this.oEditor).then(function () {
							...
							var oSelectedObject = merge(deepClone(oObject1, 500), {"_dt": {"_selected": true, "_position": 1}});
