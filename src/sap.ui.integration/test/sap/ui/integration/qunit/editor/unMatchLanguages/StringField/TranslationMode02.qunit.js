	...
	Object.keys(oSubLanguages).forEach(function(sLanguage) {
		...
		QUnit.module("Translation mode - language In " + sLanguage + ", out " + sMappingLanguage, {
			...
			Object.keys(oEditorLanguages).forEach(function(sEditorLanguage) {
				...
				QUnit.test("Editor language - " + sEditorLanguage + " : 1 string parameter with Admin change and Content change", function (assert) {
					...
					return new Promise(function (resolve, reject) {
						EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
							...
							EditorQunitUtils.wait().then(function () {
								var sExpectedValueOfOriText = _oExpectedValuesOfChangesWithTransFormat["string1string2"][sMappingLanguage] || "StringParameter Value Trans in i18n " + sMappingLanguage;
								...
								var sExpectedValueOfTransText = _oExpectedValuesOfChangesWithTransFormat["string1string2"][sMappingEditorLanguage] || "StringParameter Value Trans in i18n " + sMappingEditorLanguage;
				...
				QUnit.test("Editor language - " + sEditorLanguage + " : 1 string parameter with Admin change and Translation change", function (assert) {
					this.oEditor.setLanguage(sEditorLanguage);
					var oAdminChanges = deepClone(_oAdminChangeBase, 500);
					oAdminChanges.texts = _oTextsOfString1;
					...
					return new Promise(function (resolve, reject) {
						EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
							...
							var oField1Trans = this.oEditor.getAggregation("_formContent")[4];
							EditorQunitUtils.wait().then(function () {
								var sExpectedValueOfOriText = sLanguage === sEditorLanguage ? "String3 translation" : _oExpectedValuesOfChangesWithTransFormat["string1"][sMappingLanguage] || "StringParameter Value Trans in i18n " + sMappingLanguage;
								assert.equal(oField1Ori.getAggregation("_field").getText(), sExpectedValueOfOriText, "Field1Ori: " + sExpectedValueOfOriText);
								assert.ok(oField1Trans.getAggregation("_field").getEditable() === true, "Field1Trans: Editable");
				...
				QUnit.test("Editor language - " + sEditorLanguage + " : 1 string parameter with Content change and Translation change", function (assert) {
					this.oEditor.setLanguage(sEditorLanguage);
					var oContentChanges = deepClone(_oContentChangeBase, 500);
					oContentChanges.texts = _oTextsOfString2;
					var oTranslationChanges = deepClone(_oTranslationChangeBase, 500);
					...
					return new Promise(function (resolve, reject) {
						EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
							...
							var oField1Trans = this.oEditor.getAggregation("_formContent")[4];
							EditorQunitUtils.wait().then(function () {
								var sExpectedValueOfOriText = sLanguage === sEditorLanguage ? "String3 translation" : _oExpectedValuesOfChangesWithTransFormat["string2"][sMappingLanguage] || "StringParameter Value Trans in i18n " + sMappingLanguage;
								assert.equal(oField1Ori.getAggregation("_field").getText(), sExpectedValueOfOriText, "Field1Ori: " + sExpectedValueOfOriText);
								assert.ok(oField1Trans.getAggregation("_field").getEditable() === true, "Field1Trans: Editable");
								assert.equal(oField1Trans.getAggregation("_field").getValue(), "String3 translation", "Field1Trans: String3 translation");
								assert.ok(oField1Trans.getAggregation("_field").isA("sap.m.Input"), "Field1Trans: Input control");
				...
				QUnit.test("Editor language - " + sEditorLanguage + " : 1 string parameter with Admin change and Content change and Translation change", function (assert) {
					this.oEditor.setLanguage(sEditorLanguage);
					var oAdminChanges = deepClone(_oAdminChangeBase, 500);
					oAdminChanges.texts = _oTextsOfString1;
					var oContentChanges = deepClone(_oContentChangeBase, 500);
					...
					return new Promise(function (resolve, reject) {
						EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
							...
							var oField1Trans = this.oEditor.getAggregation("_formContent")[4];
							EditorQunitUtils.wait().then(function () {
								var sExpectedValueOfOriText = sLanguage === sEditorLanguage ? "String3 translation" : _oExpectedValuesOfChangesWithTransFormat["string1string2"][sMappingLanguage] || "StringParameter Value Trans in i18n " + sMappingLanguage;
								assert.equal(oField1Ori.getAggregation("_field").getText(), sExpectedValueOfOriText, "Field1Ori: " + sExpectedValueOfOriText);
								assert.ok(oField1Trans.getAggregation("_field").getEditable() === true, "Field1Trans: Editable");
								assert.equal(oField1Trans.getAggregation("_field").getValue(), "String3 translation", "Field1Trans: String3 translation");
								assert.ok(oField1Trans.getAggregation("_field").isA("sap.m.Input"), "Field1Trans: Input control");
