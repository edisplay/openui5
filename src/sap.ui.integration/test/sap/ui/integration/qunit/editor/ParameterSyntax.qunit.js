		...
		QUnit.test("Default without change", function (assert) {
			...
			return new Promise(function (resolve, reject) {
				EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
					...
					assert.equal(oTranslateField.getAggregation("_field").getValue(), "StringParameter Value Trans in i18n en", "Field: Translation Value");
					var oTranslateInI18nField = this.oEditor.getAggregation("_formContent")[6];
					assert.equal(oTranslateInI18nField.getAggregation("_field").getValue(), "StringParameter Value Trans in i18n en", "Field: Translation i18n Value");
					...
					assert.equal(oTranslateSyntaxField.getAggregation("_field").getValue(), "Value: StringParameter Value Trans in i18n en", "Field: parameter syntax to translate Value");
					var oTranslateInI18nSyntaxField = this.oEditor.getAggregation("_formContent")[12];
					assert.equal(oTranslateInI18nSyntaxField.getAggregation("_field").getValue(), "Value: StringParameter Value Trans in i18n en", "Field: parameter syntax to translate in i18n format Value");
					...
					assert.equal(oLocaleSyntaxField.getAggregation("_field").getValue(), "Value: " + Localization.getLanguage(), "Field: parameter syntax to LOCALE Value");
					var oMixedSyntaxField = this.oEditor.getAggregation("_formContent")[20];
					assert.ok(oMixedSyntaxField.getAggregation("_field").getValue().startsWith("Mixed value: stringParameter Value, StringParameter Value Trans in i18n en, StringParameter Value Trans in i18n en, " + oDate.toISOString().substring(0, 10)), "Field: mixed parameter syntaxs Value");
		...
		QUnit.test("Parameter change from Admin", function (assert) {
			...
			return new Promise(function (resolve, reject) {
				EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
					...
					assert.equal(oField.getAggregation("_field").getValue(), "Value: " + Localization.getLanguage(), "Field: parameter syntax to LOCALE Value");
				...
				EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
					...
					EditorQunitUtils.isReady(this.oEditor).then(function () {
						...
						EditorQunitUtils.wait(1000).then(function () {
							...
							assert.equal(oLocaleSyntaxField.getAggregation("_field").getValue(), "Value: " + Localization.getLanguage(), "Field: parameter syntax to LOCALE");
							assert.ok(oMixedSyntaxField.getAggregation("_field").getValue().startsWith("Mixed value: stringParameter New Value, StringParameter Value Trans New Value, StringParameter Value Trans in i18n New Value, " + oDate.toISOString().substring(0, 10)), "Field: mixed parameter syntaxs New Value");
							resolve();
						});
					}.bind(this));
		...
		QUnit.test("Parameter and self change from Admin and Content 3", function (assert) {
			...
			return new Promise(function (resolve, reject) {
				EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
					...
					assert.equal(oField.getAggregation("_field").getValue(), "stringParameter Value Content", "Field: String Value");
					oField = this.oEditor.getAggregation("_formContent")[4];
					assert.equal(oField.getAggregation("_field").getValue(), "StringParameter Value Trans in i18n en", "Field: Translation Value");
					oField = this.oEditor.getAggregation("_formContent")[6];
					assert.equal(oField.getAggregation("_field").getValue(), "StringParameter Value Trans Content2", "Field: Translation i18n Value");
					oField = this.oEditor.getAggregation("_formContent")[8];
					assert.equal(oField.getAggregation("_field").getValue(), "Value: parameterSyntaxNormal Value Content", "Field: Normol parameter syntax Value");
					...
					assert.equal(oField.getAggregation("_field").getValue(), "Value: parameterSyntaxToLOCALE Value Content", "Field: parameter syntax to LOCALE Value");
					oField = this.oEditor.getAggregation("_formContent")[20];
					assert.ok(oField.getAggregation("_field").getValue().startsWith("Mixed value: stringParameter Value Content, StringParameter Value Trans in i18n en, StringParameter Value Trans Content2, " + oDate.toISOString().substring(0, 10)), "Field: mixed parameter syntaxs Value");
					resolve();
				}.bind(this));
			}.bind(this));
		});
		...
		QUnit.test("Parameters with parameter syntax will not been seen", function (assert) {
			...
			return new Promise(function (resolve, reject) {
				EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
					...
					assert.equal(oTranslateField.getAggregation("_field").getText(), "StringParameter Value Trans in i18n en", "Field: Translation ori Value");
					oTranslateField = this.oEditor.getAggregation("_formContent")[7];
					assert.equal(oTranslateField.getAggregation("_field").getValue(), "StringParameter Value Trans in i18n fr", "Field: Translation trans Value");
					var oTranslateInI18nField = this.oEditor.getAggregation("_formContent")[9];
					assert.equal(oTranslateInI18nField.getAggregation("_field").getText(), "StringParameter Value Trans in i18n en", "Field: Translation i18n ori Value");
					oTranslateInI18nField = this.oEditor.getAggregation("_formContent")[10];
					assert.equal(oTranslateInI18nField.getAggregation("_field").getValue(), "StringParameter Value Trans in i18n fr", "Field: Translation i18n trans Value");
