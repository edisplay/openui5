				...
				return new Promise(function (resolve, reject) {
					EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
						...
						EditorQunitUtils.isReady(this.oEditor).then(function () {
							...
							var sExpectedValueOfText = _oExpectedValuesOfChangesWithTransFormat["string1"][sMappingLanguage] || "StringParameter Value Trans in i18n " + sMappingLanguageValue;
							...
							oField.attachEventOnce("translationPopoverOpened", function() {
								...
								for (var i = 0; i < oLanguageItems1.length; i++) {
									...
									if (!sExpectedValue) {
										sExpectedValue = _oExpectedValuesOfChangesWithTransFormat["string1"]["default"];
