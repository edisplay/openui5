...
sap.ui.define([
	...
	Object.keys(Utils.languageMapping).forEach(function(sLanguage) {
		...
		QUnit.module("Language In " + sLanguage + ", out " + sMappingLanguage, {
			...
			QUnit.test("1 string parameter with Content BC change, Translation change", function (assert) {
				var oContentChange = deepClone(_oContentChangeBase, 500);
				oContentChange.texts = _oTextsWIthBCChange;
				var oTranslationChange = deepClone(_oTranslationChangeBase, 500);
				oTranslationChange[_sManifestPath] = "String3 translation";
				this.oEditor.setJson({
					...
					manifestChanges: [oContentChange, oTranslationChange]
				});
			...
			QUnit.test("1 string parameter with Content change and BC change, Translation change", function (assert) {
				var oContentChange = deepClone(_oContentChangeBase, 500);
				var oTextsWIthChangeAndBCChange = Object.assign({}, _oTextsWIthBCChange, _oTextsWithChange);
				oContentChange.texts = oTextsWIthChangeAndBCChange;
				var oTranslationChange = deepClone(_oTranslationChangeBase, 500);
				oTranslationChange[_sManifestPath] = "String3 translation";
				this.oEditor.setJson({
					baseUrl: sBaseUrl,
