		...
		QUnit.module("Language In " + sLanguage + ", out " + sMappingLanguage, {
			...
			QUnit.test("1 string parameter with Admin BC change, Content BC change, Translation change", function (assert) {
				...
				this.oEditor.setJson({
					...
					manifestChanges: [oAdminChange, oContentChange, oTranslationChange]
				});
			...
			QUnit.test("1 string parameter with Admin change and BC change, Content change and BC change, Translation change", function (assert) {
				var oAdminChange = deepClone(_oAdminChangeBase, 500);
