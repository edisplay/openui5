				...
				return new Promise(function (resolve, reject) {
					EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
						...
						EditorQunitUtils.isReady(this.oEditor).then(function () {
							...
							assert.equal(oField.getAggregation("_field").getValue(), "StringParameter Value Trans in i18n " + sMappingLanguageValue, "Field value : StringParameter Value Trans in i18n " + sMappingLanguageValue);
							...
							oField.attachEventOnce("translationPopoverOpened", function() {
								...
								assert.equal(aHeaderItems1[2].getItems()[1].getValue(), "StringParameter Value Trans in i18n " + sMappingLanguageValue, "oTranslationPopover Header: String1 Value");
