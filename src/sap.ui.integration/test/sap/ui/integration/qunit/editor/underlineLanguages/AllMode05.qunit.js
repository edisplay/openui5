...
sap.ui.define([
	...
	Object.keys(_oLanguageMapping).forEach(function(sLanguage) {
		...
		QUnit.module("Language In " + sLanguage + ", out " + sMappingLanguage, {
			...
			QUnit.test("1 string parameter with Admin and Content translations", function (assert) {
				...
				return new Promise(function (resolve, reject) {
					EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
						...
						EditorQunitUtils.isReady(this.oEditor).then(function () {
							...
							var sExpectedValueOfText = _oExpectedValuesOfChangesWithTransFormat["string1string2"][sMappingLanguage] || "StringParameter Value Trans in i18n " + sMappingLanguageValue;
