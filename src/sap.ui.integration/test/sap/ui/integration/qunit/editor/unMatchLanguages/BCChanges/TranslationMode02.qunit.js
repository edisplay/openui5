	...
	Object.keys(oSubLanguages).forEach(function(sLanguage) {
		...
		QUnit.module("Translation mode - language In " + sLanguage + ", out " + sMappingLanguage, {
			...
			Object.keys(oEditorLanguages).forEach(function(sEditorLanguage) {
				QUnit.test("Editor language - " + sEditorLanguage + " : 1 string parameter with Admin BC change, Translation change", function (assert) {
					...
					this.oEditor.setJson({
						...
						manifestChanges: [oAdminChange, oTranslationChanges]
					});
					return new Promise(function (resolve, reject) {
						EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
							...
							EditorQunitUtils.wait().then(function () {
								var sExpectedValueOfOriText = sLanguage === sEditorLanguage ? "String3 translation" : _oExpectedValuesOfBCChange["string1"][sMappingLanguage] || "StringParameter Value Trans in i18n " + sMappingLanguage;
				...
				QUnit.test("Editor language - " + sEditorLanguage + " : 1 string parameter with Admin change and BC change, Translation change", function (assert) {
					this.oEditor.setLanguage(sEditorLanguage);
					var oAdminChange = deepClone(_oAdminChangeBase, 500);
					...
					return new Promise(function (resolve, reject) {
						EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
							...
							var oField1Trans = this.oEditor.getAggregation("_formContent")[4];
							EditorQunitUtils.wait().then(function () {
								var sExpectedValueOfOriText = sLanguage === sEditorLanguage ? "String3 translation" : _oExpectedValuesOfChangeAndBCChange["string1"][sMappingLanguage] || "StringParameter Value Trans in i18n " + sMappingLanguage;
								assert.equal(oField1Ori.getAggregation("_field").getText(), sExpectedValueOfOriText, "Field1Ori: " + sExpectedValueOfOriText);
								assert.ok(oField1Trans.getAggregation("_field").getEditable() === true, "Field1Trans: Editable");
								assert.equal(oField1Trans.getAggregation("_field").getValue(), "String3 translation", "Field1Trans: String3 translation");
								assert.ok(oField1Trans.getAggregation("_field").isA("sap.m.Input"), "Field1Trans: Input control");
				...
				QUnit.test("Editor language - " + sEditorLanguage + " : 1 string parameter with Content BC change, Translation change", function (assert) {
					this.oEditor.setLanguage(sEditorLanguage);
					...
					this.oEditor.setJson({
						...
						manifestChanges: [oContentChange, oTranslationChanges]
					});
					return new Promise(function (resolve, reject) {
						EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
							assert.equal(Utils._language, sMappingLanguage, "Utils._language is ok");
							...
							var oField1Trans = this.oEditor.getAggregation("_formContent")[4];
							EditorQunitUtils.wait().then(function () {
								var sExpectedValueOfOriText = sLanguage === sEditorLanguage ? "String3 translation" : _oExpectedValuesOfBCChange["string2"][sMappingLanguage] || "StringParameter Value Trans in i18n " + sMappingLanguage;
								assert.equal(oField1Ori.getAggregation("_field").getText(), sExpectedValueOfOriText, "Field1Ori: " + sExpectedValueOfOriText);
								assert.ok(oField1Trans.getAggregation("_field").getEditable() === true, "Field1Trans: Editable");
								assert.equal(oField1Trans.getAggregation("_field").getValue(), "String3 translation", "Field1Trans: String3 translation");
								assert.ok(oField1Trans.getAggregation("_field").isA("sap.m.Input"), "Field1Trans: Input control");
				...
				QUnit.test("Editor language - " + sEditorLanguage + " : 1 string parameter with Content change and BC change, Translation change", function (assert) {
					this.oEditor.setLanguage(sEditorLanguage);
					var oContentChange = deepClone(_oContentChangeBase, 500);
					...
					return new Promise(function (resolve, reject) {
						EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
							...
							var oField1Trans = this.oEditor.getAggregation("_formContent")[4];
							EditorQunitUtils.wait().then(function () {
								var sExpectedValueOfOriText = sLanguage === sEditorLanguage ? "String3 translation" : _oExpectedValuesOfChangeAndBCChange["string2"][sMappingLanguage] || "StringParameter Value Trans in i18n " + sMappingLanguage;
								assert.equal(oField1Ori.getAggregation("_field").getText(), sExpectedValueOfOriText, "Field1Ori: " + sExpectedValueOfOriText);
								assert.ok(oField1Trans.getAggregation("_field").getEditable() === true, "Field1Trans: Editable");
								assert.equal(oField1Trans.getAggregation("_field").getValue(), "String3 translation", "Field1Trans: String3 translation");
								assert.ok(oField1Trans.getAggregation("_field").isA("sap.m.Input"), "Field1Trans: Input control");
				...
				QUnit.test("Editor language - " + sEditorLanguage + " : 1 string parameter with Admin BC change, Content BC change, Translation change", function (assert) {
					this.oEditor.setLanguage(sEditorLanguage);
					var oAdminChange = deepClone(_oAdminChangeBase, 500);
					oAdminChange.texts = _oTextsWithBCChangeOfString1;
					var oContentChange = deepClone(_oContentChangeBase, 500);
					...
					this.oEditor.setJson({
						...
						manifestChanges: [oAdminChange, oContentChange, oTranslationChanges]
					});
					return new Promise(function (resolve, reject) {
						EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
							assert.equal(Utils._language, sMappingLanguage, "Utils._language is ok");
							...
							var oField1Trans = this.oEditor.getAggregation("_formContent")[4];
							EditorQunitUtils.wait().then(function () {
								var sExpectedValueOfOriText = sLanguage === sEditorLanguage ? "String3 translation" : _oExpectedValuesOfBCChange["string1string2"][sMappingLanguage] || "StringParameter Value Trans in i18n " + sMappingLanguage;
								assert.equal(oField1Ori.getAggregation("_field").getText(), sExpectedValueOfOriText, "Field1Ori: " + sExpectedValueOfOriText);
								assert.ok(oField1Trans.getAggregation("_field").getEditable() === true, "Field1Trans: Editable");
								assert.equal(oField1Trans.getAggregation("_field").getValue(), "String3 translation", "Field1Trans: String3 translation");
								assert.ok(oField1Trans.getAggregation("_field").isA("sap.m.Input"), "Field1Trans: Input control");
				...
				QUnit.test("Editor language - " + sEditorLanguage + " : 1 string parameter with Admin change and BC change, Content change and BC change, Translation change", function (assert) {
					this.oEditor.setLanguage(sEditorLanguage);
					var oAdminChange = deepClone(_oAdminChangeBase, 500);
					var oTextsWIthChangeAndBCChangeOfString1 = Object.assign({}, _oTextsWithBCChangeOfString1, _oTextsWithChangeOfString1);
					oAdminChange.texts = oTextsWIthChangeAndBCChangeOfString1;
					...
					return new Promise(function (resolve, reject) {
						EditorQunitUtils.isFieldReady(this.oEditor).then(function () {
							...
							var oField1Trans = this.oEditor.getAggregation("_formContent")[4];
							EditorQunitUtils.wait().then(function () {
								var sExpectedValueOfOriText = sLanguage === sEditorLanguage ? "String3 translation" : _oExpectedValuesOfChangeAndBCChange["string1string2"][sMappingLanguage] || "StringParameter Value Trans in i18n " + sMappingLanguage;
								assert.equal(oField1Ori.getAggregation("_field").getText(), sExpectedValueOfOriText, "Field1Ori: " + sExpectedValueOfOriText);
								assert.ok(oField1Trans.getAggregation("_field").getEditable() === true, "Field1Trans: Editable");
								assert.equal(oField1Trans.getAggregation("_field").getValue(), "String3 translation", "Field1Trans: String3 translation");
								assert.ok(oField1Trans.getAggregation("_field").isA("sap.m.Input"), "Field1Trans: Input control");
