...
], function (ODataTableDelegate, OrdersFBDelegate, Field, Link, FieldDisplay, FieldEditMode, OperatorName, FilterUtil, DelegateUtil, Filter, FilterOperator, CurrencyType, DecimalType, StringType, Text, DelegateCache) {
	"use strict";
