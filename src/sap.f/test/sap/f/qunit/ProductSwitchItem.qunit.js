...
sap.ui.define(["sap/f/ProductSwitchItem", "sap/ui/qunit/utils/nextUIUpdate"],
	function (ProductSwitchItem, nextUIUpdate) {
		...
		QUnit.test("ProductSwitchItem is instantiated successfully", function (assert) {
			assert.ok(this.oProductSwitchItem, "The ProductSwitchitem is instantiated successfully");
		});

		QUnit.test("src property default value and changes are reflected correctly", async function (assert) {
		...
		QUnit.test("title property default value and changes are reflected correctly", async function (assert) {
		...
		QUnit.test("subTitle property default value and changes are reflected correctly", async function (assert) {
		...
		QUnit.test("targetSrc property default value and changes are reflected correctly", async function (assert) {
		...
		QUnit.test("target property default value and changes are reflected correctly", async function (assert) {
		...
		QUnit.test("_icon internal aggregation is instantiated with the correct type", function (assert) {
		...
		QUnit.test("_title internal aggregation is instantiated with the correct type", function (assert) {
		...
		QUnit.test("_title aggregation has the expected additional CSS classes", function (assert) {
		...
		QUnit.test("ARIA role attribute is set correctly on the ProductSwitchItem DOM element", function (assert) {
			// Arrange
