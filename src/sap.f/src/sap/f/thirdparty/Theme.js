sap.ui.define(['module', 'exports'], (function (module, exports) { 'use strict';
	...
	const u$9=()=>{const t=document.createElement("meta");return t.setAttribute("name","ui5-shared-resources"),t.setAttribute("content",""),t},l$a=()=>typeof document>"u"?null:o$a('meta[name="ui5-shared-resources"]',document.head,u$9),m$9=(t,o)=>{const r=t.split(".");let e=l$a();if(!e)return o;for(let n=0;n<r.length;n++){const s=r[n],c=n===r.length-1;Object.prototype.hasOwnProperty.call(e,s)||(e[s]=c?o:{}),e=e[s];}return e};

	const g$5=m$9("Tags",new Map),d$9=new Set;let i$b=new Map,c$a;const m$8=-1,h$3=e=>{d$9.add(e),g$5.set(e,h$2());},w$6=e=>d$9.has(e),R$2=()=>d$9.size>0,T$3=()=>[...d$9.values()],$=e=>{let n=g$5.get(e);n===void 0&&(n=m$8),i$b.has(n)||i$b.set(n,new Set),i$b.get(n).add(e),c$a||(c$a=setTimeout(()=>{y$4(),i$b=new Map,c$a=void 0;},1e3));},y$4=()=>{const e=b$5(),n=h$2(),l=e[n];let t="Multiple UI5 Web Components instances detected.";e.length>1&&(t=`${t}
...
To prevent other runtimes from defining tags that you use, consider using scoping or have third-party libraries use scoping: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md.`,console.warn(t);};
	...
	const e$7={version:"2.23.2",major:2,minor:23,patch:2,suffix:"",isNext:false,buildTime:1782484484};

	let s$a,t$d={include:[/./],exclude:[]};const o$9=new Map,p$1=e=>{if(!e.match(/^[a-zA-Z0-9_-]+$/))throw new Error("Only alphanumeric characters and dashes allowed for the scoping suffix");R$2()&&console.warn("Setting the scoping suffix must be done before importing any components. For proper usage, read the scoping section: https://github.com/UI5/webcomponents/blob/main/docs/2-advanced/06-scoping.md."),s$a=e;},c$9=()=>s$a,g$4=e=>{if(!e||!e.include)throw new Error('"rules" must be an object with at least an "include" property');if(!Array.isArray(e.include)||e.include.some(n=>!(n instanceof RegExp)))throw new Error('"rules.include" must be an array of regular expressions');if(e.exclude&&(!Array.isArray(e.exclude)||e.exclude.some(n=>!(n instanceof RegExp))))throw new Error('"rules.exclude" must be an array of regular expressions');e.exclude=e.exclude||[],t$d=e,o$9.clear();},m$7=()=>t$d,i$a=e=>{if(!o$9.has(e)){const n=t$d.include.some(r=>e.match(r))&&!t$d.exclude.some(r=>e.match(r));o$9.set(e,n);}return o$9.get(e)},d$8=e=>{if(i$a(e))return c$9()},f$7=(e,n=false)=>{if(!n)return e;const r=`v${e$7.version.replaceAll(".","-")}`,a=/(--_?ui5)([^,:)\s]+)/g;return e.replaceAll(a,`$1-${r}$2`)};

	let s$9,u$8="";const c$8=new Map,o$8=m$9("Runtimes",[]),d$7=()=>{if(s$9===void 0){s$9=o$8.length;const e=e$7;o$8.push({...e,get scopingSuffix(){return c$9()},get registeredTags(){return T$3()},get scopingRules(){return m$7()},alias:u$8,description:`Runtime ${s$9} - ver ${e.version}${""}`,importMetaUrl:new URL(sap.ui.require.toUrl("sap/f/thirdparty/Theme"), document.baseURI).href});}},h$2=()=>s$9,a$c=(e,t)=>{if(e.isNext||t.isNext)return e.buildTime-t.buildTime;const r=e.major-t.major;if(r)return r;const n=e.minor-t.minor;if(n)return n;const i=e.patch-t.patch;return i||new Intl.Collator(void 0,{numeric:true,sensitivity:"base"}).compare(e.suffix,t.suffix)},I$2=(e,t)=>{const r=`${e},${t}`;if(c$8.has(r))return c$8.get(r);const n=o$8[e],i=o$8[t];if(!n||!i)throw new Error("Invalid runtime index supplied");const m=a$c(n,i);return c$8.set(r,m),m},b$5=()=>o$8;

	const c$7=typeof document>"u",i$9=(e,t)=>t?`${e}|${t}`:e,l$9=e=>e===void 0?true:I$2(h$2(),parseInt(e))>=1,y$3=(e,t,r="",s)=>{const d=h$2(),n=new CSSStyleSheet;n.replaceSync(e),n._ui5StyleId=i$9(t,r),s&&(n._ui5RuntimeIndex=d,n._ui5Theme=s),document.adoptedStyleSheets=[...document.adoptedStyleSheets,n];},S$1=(e,t,r="",s)=>{if(c$7)return;const d=h$2(),n=document.adoptedStyleSheets.find(o=>o._ui5StyleId===i$9(t,r));if(n)if(!s)n.replaceSync(e||"");else {const o=n._ui5RuntimeIndex;(n._ui5Theme!==s||l$9(o))&&(n.replaceSync(e||""),n._ui5RuntimeIndex=String(d),n._ui5Theme=s);}},a$b=(e,t="")=>c$7?true:!!document.adoptedStyleSheets.find(r=>r._ui5StyleId===i$9(e,t)),f$6=(e,t="")=>{document.adoptedStyleSheets=document.adoptedStyleSheets.filter(r=>r._ui5StyleId!==i$9(e,t));},R$1=(e,t,r="",s)=>{a$b(t,r)?S$1(e,t,r,s):y$3(e,t,r,s);},m$6=(e,t)=>e===void 0?t:t===void 0?e:`${e} ${t}`;

	const e$6=new Map,s$8=(t,r)=>{e$6.set(t,r);},n$8=t=>e$6.get(t);

	var c$6={},e$5=c$6.hasOwnProperty,a$a=c$6.toString,o$7=e$5.toString,l$8=o$7.call(Object),i$8=function(r){var t,n;return !r||a$a.call(r)!=="[object Object]"?false:(t=Object.getPrototypeOf(r),t?(n=e$5.call(t,"constructor")&&t.constructor,typeof n=="function"&&o$7.call(n)===l$8):true)};
	...
	const o$6=typeof document>"u",n$6={search(){return o$6?"":window.location.search}},i$5=()=>o$6?"":window.location.hostname,c$4=()=>o$6?"":window.location.port,a$8=()=>o$6?"":window.location.protocol,s$6=()=>o$6?"":window.location.href,u$5=()=>n$6.search();

	let g$3=false,t$b={animationMode:u$6.Full,theme:e$3,themeRoot:void 0,rtl:void 0,language:void 0,timezone:void 0,calendarType:void 0,secondaryCalendarType:void 0,noConflict:false,formatSettings:{},fetchDefaultLanguage:false,defaultFontLoading:true,enableDefaultTooltips:true,ignoreUrlParams:false};const y$2=()=>(o$5(),t$b.animationMode),C$3=()=>(o$5(),t$b.theme),T$2=()=>(o$5(),t$b.themeRoot),S=()=>(o$5(),t$b.language),U$2=()=>(o$5(),t$b.fetchDefaultLanguage),L$1=()=>(o$5(),t$b.noConflict),F=()=>(o$5(),t$b.defaultFontLoading),b$4=()=>(o$5(),t$b.enableDefaultTooltips),I$1=()=>(o$5(),t$b.ignoreUrlParams),D=()=>(o$5(),t$b.calendarType),R=()=>(o$5(),t$b.formatSettings),i$4=new Map;i$4.set("true",true),i$4.set("false",false);const M=()=>{const n=document.querySelector("[data-ui5-config]")||document.querySelector("[data-id='sap-ui-config']");let e;if(n){try{e=JSON.parse(n.innerHTML);}catch{console.warn("Incorrect data-sap-ui-config format. Please use JSON");}e&&(t$b=e$4(t$b,e));}},z=()=>{const n=new URLSearchParams(u$5());n.forEach((e,r)=>{const a=r.split("sap-").length;a===0||a===r.split("sap-ui-").length||l$7(r,e,"sap");}),n.forEach((e,r)=>{r.startsWith("sap-ui")&&l$7(r,e,"sap-ui");});},E$1=n=>n.split("@")[1],w$5=(n,e)=>n==="theme"&&e.includes("@")?e.split("@")[0]:e,l$7=(n,e,r)=>{const a=e.toLowerCase(),s=n.split(`${r}-`)[1];i$4.has(e)&&(e=i$4.get(a)),s==="theme"?(t$b.theme=w$5(s,e),e&&e.includes("@")&&(t$b.themeRoot=E$1(e))):t$b[s]=e;},j=()=>{const n=n$8("OpenUI5Support");if(!n||!n.isOpenUI5Detected())return;const e=n.getConfigurationSettingsObject();t$b=e$4(t$b,e);},o$5=()=>{typeof document>"u"||g$3||(u$4(),g$3=true);},u$4=n=>{M(),t$b.ignoreUrlParams||z(),j();};

	let l$6 = class l{constructor(){this.list=[],this.lookup=new Set;}add(t){this.lookup.has(t)||(this.list.push(t),this.lookup.add(t));}remove(t){this.lookup.has(t)&&(this.list=this.list.filter(e=>e!==t),this.lookup.delete(t));}shift(){const t=this.list.shift();if(t)return this.lookup.delete(t),t}isEmpty(){return this.list.length===0}isAdded(t){return this.lookup.has(t)}process(t){let e;const s=new Map;for(e=this.shift();e;){const i=s.get(e)||0;if(i>10)throw new Error("Web component processed too many times this task, max allowed is: 10");t(e),s.set(e,i+1),e=this.shift();}}};

	const t$a=new Set,n$5=e=>{t$a.add(e);},r$b=e=>t$a.has(e);

	const i$3=new Set,m$5=new i$7,n$4=new l$6;let t$9,a$7,d$6,s$5;const l$5=async e=>{n$4.add(e),await U$1();},c$3=e=>{i$3.add(e);},f$5=e=>{i$3.delete(e);},u$3=e=>{m$5.fireEvent("beforeComponentRender",e),c$3(e),e._render();},P$2=e=>{n$4.remove(e),f$5(e);},U$1=async()=>{s$5||(s$5=new Promise(e=>{window.requestAnimationFrame(()=>{n$4.process(u$3),s$5=null,e(),d$6||(d$6=setTimeout(()=>{d$6=void 0,n$4.isEmpty()&&T$1();},200));});})),await s$5;},y$1=()=>t$9||(t$9=new Promise(e=>{a$7=e,window.requestAnimationFrame(()=>{n$4.isEmpty()&&(t$9=void 0,e());});}),t$9),C$2=()=>{const e=T$3().map(r=>customElements.whenDefined(r));return Promise.all(e)},w$4=async()=>{await C$2(),await y$1();},T$1=()=>{n$4.isEmpty()&&a$7&&(a$7(),a$7=void 0,t$9=void 0);},b$3=async e=>{i$3.forEach(r=>{const o=r.constructor,E=o.getMetadata().getTag(),p=r$b(o),g=o.getMetadata().isLanguageAware(),v=o.getMetadata().isThemeAware();(!e||e.tag===E||e.rtlAware&&p||e.languageAware&&g||e.themeAware&&v)&&l$5(r);}),await w$4();};

	const t$8=new i$7,r$a="themeRegistered",n$3=e=>{t$8.attachEvent(r$a,e);},s$4=e=>t$8.fireEvent(r$a,e);

	const l$4=new Map,T=new Map,h$1=new Map,u$2=new Map,a$6=new Set,f$4=(e,r,t,s="root")=>{T.set(`${e}/${r}`,t),u$2.set(e,{cssVariablesTarget:s}),a$6.add(r),s$4(r);},L=async(e,r,t)=>{const s=`${e}_${r}_${t||""}`,o=l$4.get(s);if(o!==void 0)return o;if(!a$6.has(r)){const p=[...a$6.values()].join(", ");return console.warn(`You have requested a non-registered theme ${r} - falling back to ${e$3}. Registered themes are: ${p}`),c$2(e,e$3)}const[n,g]=await Promise.all([c$2(e,r),t?c$2(e,t,true):void 0]),i=m$6(n,g);return i&&l$4.set(s,i),i},c$2=async(e,r,t=false)=>{const o=(t?h$1:T).get(`${e}/${r}`);if(!o){t||console.error(`Theme [${r}] not registered for package [${e}]`);return}let n;try{n=await o(r);}catch(g){console.error(e,g.message);return}return n},m$4=()=>u$2,w$3=e=>a$6.has(e);

	const r$9=new Set,s$3=()=>{let e=document.querySelector(".sapThemeMetaData-Base-baseLib")||document.querySelector(".sapThemeMetaData-UI5-sap-ui-core");if(e)return getComputedStyle(e).backgroundImage;e=document.createElement("span"),e.style.display="none",e.classList.add("sapThemeMetaData-Base-baseLib"),document.body.appendChild(e);let t=getComputedStyle(e).backgroundImage;return t==="none"&&(e.classList.add("sapThemeMetaData-UI5-sap-ui-core"),t=getComputedStyle(e).backgroundImage),document.body.removeChild(e),t},o$4=e=>{const t=/\(["']?data:text\/plain;utf-8,(.*?)['"]?\)$/i.exec(e);if(t&&t.length>=2){let a=t[1];if(a=a.replace(/\\"/g,'"'),a.charAt(0)!=="{"&&a.charAt(a.length-1)!=="}")try{a=decodeURIComponent(a);}catch{r$9.has("decode")||(console.warn("Malformed theme metadata string, unable to decodeURIComponent"),r$9.add("decode"));return}try{return JSON.parse(a)}catch{r$9.has("parse")||(console.warn("Malformed theme metadata string, unable to parse JSON"),r$9.add("parse"));}}},d$5=e=>{let t,a;try{const n=e.Path.split(".");t=n.length===4?n[2]:getComputedStyle(document.body).getPropertyValue("--sapSapThemeId"),a=e.Extends[0];}catch{r$9.has("object")||(console.warn("Malformed theme metadata Object",e),r$9.add("object"));return}return {themeName:t,baseThemeName:a}},m$3=()=>{const e=s$3();if(!e||e==="none")return;const t=o$4(e);if(t)return d$5(t)};

	const t$7=new i$7,d$4="themeLoaded",o$3=e=>{t$7.attachEvent(d$4,e);},n$2=e=>{t$7.detachEvent(d$4,e);},r$8=e=>t$7.fireEvent(d$4,e);
	...
	const a$5=t=>{const e=document.querySelector(`META[name="${t}"]`);return e&&e.getAttribute("content")},g$2=(t,e=false)=>{const n=a$5("sap-allowed-theme-origins")??a$5("sap-allowedThemeOrigins");return n?e?true:n.split(",").some(r=>r==="*"||t===r.trim()):false},l$3=t=>{let e,n=false;try{if(t.startsWith(".")||t.startsWith("/")&&!t.startsWith("//"))e=new URL(t,s$6()).toString(),n=!0;else {const r=t.startsWith("//")?new URL(t,s$6()):new URL(t),i=r.origin,o=new URL(s$6()).origin;if(n=i===o,i&&g$2(i,n))e=r.toString();else return}return e.endsWith("/")||(e=`${e}/`),`${e}UI5/`}catch{return}};

	let t$6;i$6(()=>{t$6=void 0;});const r$7=()=>(t$6===void 0&&(t$6=T$2()),t$6),f$3=(e,o)=>`${o}Base/baseLib/${e}/css_variables.css`,s$2=async e=>{const o=document.querySelector(`[sap-ui-webcomponents-theme="${e}"]`);o&&document.head.removeChild(o);const n=r$7();if(!n)return;const i=l$3(n);if(!i){console.warn(`The ${n} is not valid. Check the allowed origins as suggested in the "setThemeRoot" description.`);return}await d$3(f$3(e,i),{"sap-ui-webcomponents-theme":e});};

	const t$5=new Map;let e$1;const n$1=()=>(e$1||(e$1=new CSSStyleSheet),e$1),r$6=(o,s)=>{t$5.set(o,s);const S=Array.from(t$5.values()).join(`
`);n$1().replaceSync(S);};

	let _lib="ui5",_package="webcomponents-theming";const a$4="@"+_lib+"/"+_package,E=()=>m$4().has(a$4),U=async e=>{if(!E())return;const t=await L(a$4,e);t&&R$1(t,"data-ui5-theme-properties",a$4,e);},w$2=()=>{f$6("data-ui5-theme-properties",a$4);},I=async(e,t)=>{const o=[...m$4().entries()].map(async([s,{cssVariablesTarget:n}])=>{if(s===a$4)return;const i=await L(s,e,t);i&&(n==="root"?R$1(i,`data-ui5-component-properties-${h$2()}`,s):n==="host"&&r$6(s,i));});return Promise.all(o)},O$1=async e=>{const t=m$3();if(t)return t;const r=n$8("OpenUI5Support");if(r&&r.isOpenUI5Detected()){if(r.cssVariablesLoaded())return {themeName:r.getConfigurationSettingsObject()?.theme,baseThemeName:""}}else if(r$7())return await s$2(e),m$3()},b$2=async e=>{const t=await O$1(e);!t||e!==t.themeName?await U(e):w$2();const r=t&&t.themeName===e?e:void 0,o=t&&t.baseThemeName,s=w$3(e)?e:o||e$3;await I(s,r),B(o),r$8(e);};

	const d$2=()=>new Promise(e=>{document.body?e():document.addEventListener("DOMContentLoaded",()=>{e();});});

	var r$5 = `@font-face{font-family:"72";font-style:normal;font-weight:400;src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.36.3/content/Base/baseLib/baseTheme/fonts/72-Regular.woff2) format("woff2"),local("72");unicode-range:U+00,U+0D,U+20-7E,U+A0-FF,U+131,U+152-153,U+161,U+178,U+17D-17E,U+192,U+237,U+2C6,U+2DC,U+3BC,U+1E9E,U+2013-2014,U+2018-201A,U+201C-201E,U+2020-2022,U+2026,U+2030,U+2039-203A,U+2044,U+20AC,U+2122}
...
@font-face{font-family:"72Mono-Boldfull";src:url(https://cdn.jsdelivr.net/npm/@sap-theming/theming-base-content@11.36.3/content/Base/baseLib/baseTheme/fonts/72Mono-Bold-full.woff2) format("woff2")}`;
	...
	const n=()=>{const t=n$8("OpenUI5Support");(!t||!t.isOpenUI5Detected())&&a$2();},a$2=()=>{const t=document.querySelector("head>style[data-ui5-font-face]");!a$3()||t||R$1(r$5,"data-ui5-font-face");};

	var s$1 = ":root{--_ui5-cozy-size:var(--_ui5-f2d95f8);--_ui5-compact-size: ;--_ui5_content_density:cozy}.sapUiSizeCompact,.ui5-content-density-compact,[data-ui5-compact-size]{--_ui5-cozy-size: ;--_ui5-compact-size:var(--_ui5-f2d95f8);--_ui5_content_density:compact}";

	const r$4=()=>{R$1(s$1,"data-ui5-system-css-vars");};

	var t$4 = "html:not(.ui5-content-native-scrollbars){scrollbar-color:var(--sapScrollBar_FaceColor) var(--sapScrollBar_TrackColor)}";

	const l$2=()=>{R$1(t$4,"data-ui5-scrollbar-styles");};
	...
	let r$2=false,i,p=false;const m$1=new i$7,w=()=>r$2,O=t=>{if(!r$2){m$1.attachEvent("boot",t);return}t();},f$1=async()=>{const t=n$8("OpenUI5Support"),e=t?t.isOpenUI5Detected():false,o=n$8("F6Navigation");t&&(o&&o.destroy(),await t.init()),o&&!e&&o.init();},c=()=>{if(p)return;const t=n$8("OpenUI5Support");t&&(p=t.attachListeners());},u=async()=>{if(i!==void 0)return i;const t=async e=>{if(d$7(),typeof document>"u"){e();return}n$3(b),await f$1(),await d$2(),await b$2(r()),c(),n(),r$4(),l$2(),i$1(),e(),r$2=true,m$1.fireEvent("boot");};return i=new Promise(t),i},P=async()=>{await u(),await f$1(),c(),await b$2(r());},b=t=>{if(!r$2)return;const e=r(),o=A();(t===e||t===o)&&b$2(e);};
	...
	let t,o;i$6(()=>{t=void 0;}),C$1("theme",e=>{t=e,w()&&b$2(t).then(()=>b$3({themeAware:true}));});const r=()=>(t===void 0&&(t=f("theme")??C$3()),t),l=async e=>{t!==e&&(t=e,d("theme",e),w()&&(await b$2(t),await b$3({themeAware:true})));},y=()=>e$3,m=()=>{const e=r();return C(e)?!e.startsWith("sap_horizon"):!m$3()?.baseThemeName?.startsWith("sap_horizon")},C=e=>s$7.includes(e),A=()=>o,B=e=>{o=e;};
